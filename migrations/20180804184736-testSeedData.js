    ...
    async.series(
        [
            ...
            db.insert.bind(
                ...
                [user_id1, 'Luke', 'Skywalker', null, 'wompratkiller@test.com', 'guest', '1951-09-25', defaultTimeStamp]
            ),
            db.insert.bind(
                db,
                'users',
            ...
            db.insert.bind(
                ...
                'users',
                ['id', 'name_first', 'name_last', 'name_middle', 'email', 'password', 'date_birth', 'created_at'],
                [user_id3, 'Obiwan', 'Kenobi', null, 'hellothere@test.com', 'guest', '1971-03-31', defaultTimeStamp]
            ),
            db.insert.bind(
                db,
                'users',
