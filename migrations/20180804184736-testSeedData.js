  ...
  async.series(
    [
      ...
      db.insert.bind(db, 'companies',
        ...
        db.insert.bind(db, 'companies',
            ['id', 'name_company', 'shortname_company'],
            [company_id2, 'Blizzard', 'Blizz']
        ),
        db.insert.bind(db, 'companies',
            ['id', 'name_company', 'shortname_company'],
            [company_id3, 'Valve', 'Val']
        ),
        db.insert.bind(db, 'companies',
            ['id', 'name_company', 'shortname_company'],
            [company_id4, 'Nintendo', 'Nin']
        ),
      ...
      db.insert.bind(db, 'company_addresses',
        ...
        // crews
        db.insert.bind(db, 'crews',
            ['id', 'company_id', 'name_crew'],
            [crew_id1, company_id1, 'Magic Rags']
        ),
        db.insert.bind(db, 'crews',
            ['id', 'company_id', 'name_crew'],
            [crew_id2, company_id2, 'Kompletely Klean']
        ),
        db.insert.bind(db, 'crews',
            ['id', 'company_id', 'name_crew'],
            [crew_id3, company_id3, 'Filth Fighters']
        ),
        db.insert.bind(db, 'crews',
            ['id', 'company_id', 'name_crew'],
            [crew_id4, company_id4, 'Scrub-a-Dub-Dub']
        ),
      ...
      // properties
      db.insert.bind(db, 'properties',
          ['id', 'user_id', 'name_property'],
          [1, user_id1, 'Brett\'s house', ]
      ),
        db.insert.bind(db, 'properties',
            ['id', 'user_id', 'name_property'],
            [2, user_id2, 'Dal\'s house', ]
        ),
        db.insert.bind(db, 'properties',
            ['id', 'user_id', 'name_property'],
            [3, user_id3, 'Neal\'s house', ]
        ),
        db.insert.bind(db, 'properties',
            ['id', 'user_id', 'name_property'],
            [4, user_id4, 'Brett\'s second house', ]
        ),

      // property addresses
      db.insert.bind(db, 'property_addresses',
      ...
      // property rooms
      db.insert.bind(db, 'property_rooms',
          ['id', 'property_id', 'name_property_room'],
          [1, 1, 'Living room']
      ),
        db.insert.bind(db, 'property_rooms',
            ['id', 'property_id', 'name_property_room'],
      ...
      db.insert.bind(db, 'property_room_fixtures',
      ...
      // jobs
      db.insert.bind(db, 'jobs',
          ['id', 'crew_id', 'user_id', 'property_id', 'date_scheduled', 'date_starts', 'estimated_duration', 'date_arrived', 'date_completed', 'tip_amount'],
          [job_id1, crew_id1, user_id1, 1, '2018-09-25', '2018-09-26', 2, '2018-09-26', '2018-09-26', 5.00]
      ),
        db.insert.bind(db, 'jobs',
            ['id', 'crew_id', 'user_id', 'property_id', 'date_scheduled', 'date_starts', 'estimated_duration', 'date_arrived', 'date_completed', 'tip_amount'],
            [job_id2, crew_id2, user_id2, 2, '2018-10-20', '2018-10-21', 1, '2018-10-21', '2018-10-21', 10.00]
        ),
        db.insert.bind(db, 'jobs',
            ['id', 'crew_id', 'user_id', 'property_id', 'date_scheduled', 'date_starts', 'estimated_duration', 'date_arrived', 'date_completed', 'tip_amount'],
            [job_id3, crew_id3, user_id3, 3, '2019-01-05', '2019-01-06', 3, '2019-01-06', '2019-01-06', 25.00]
        ),
        db.insert.bind(db, 'jobs',
            ['id', 'crew_id', 'user_id', 'property_id', 'date_scheduled', 'date_starts', 'estimated_duration', 'date_arrived', 'date_completed', 'tip_amount'],
            [job_id4, crew_id4, user_id4, 4, '2019-02-17', '2019-02-18', 4, '2019-02-18', '2019-02-18', 20.00]
        ),

      // job rooms
      db.insert.bind(db, 'job_rooms',
      ...
      // job room fixtures
      db.insert.bind(db, 'job_room_fixtures',
      ...
      db.insert.bind(db, 'job_room_fixture_tasks',
