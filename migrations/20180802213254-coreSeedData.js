...
exports.up = function(db, callback) {
    async.series(
        [
            ...
            db.insert.bind(db, 'fixtures', ['id', 'name_fixture', 'created_at'], [1, 'floor', defaultTimeStamp]),
            db.insert.bind(db, 'fixtures', ['id', 'name_fixture', 'created_at'], [2, 'walls', defaultTimeStamp]),
            db.insert.bind(db, 'fixtures', ['id', 'name_fixture', 'created_at'], [3, 'baseboards', defaultTimeStamp]),
            db.insert.bind(db, 'fixtures', ['id', 'name_fixture', 'created_at'], [4, 'counter_tops', defaultTimeStamp]),
            db.insert.bind(db, 'fixtures', ['id', 'name_fixture', 'created_at'], [5, 'sink', defaultTimeStamp]),
            db.insert.bind(db, 'fixtures', ['id', 'name_fixture', 'created_at'], [6, 'stove', defaultTimeStamp]),
            db.insert.bind(db, 'fixtures', ['id', 'name_fixture', 'created_at'], [7, 'oven', defaultTimeStamp]),
            // tasks table - name_task (id is autoincrement)
            db.insert.bind(db, 'tasks', ['id', 'name_task', 'created_at'], [1, 'sweep', defaultTimeStamp]),
            db.insert.bind(db, 'tasks', ['id', 'name_task', 'created_at'], [2, 'mop', defaultTimeStamp]),
            db.insert.bind(db, 'tasks', ['id', 'name_task', 'created_at'], [3, 'vacuum', defaultTimeStamp]),
            db.insert.bind(db, 'tasks', ['id', 'name_task', 'created_at'], [4, 'dust', defaultTimeStamp]),
            db.insert.bind(db, 'tasks', ['id', 'name_task', 'created_at'], [5, 'wipe', defaultTimeStamp]),
            // fixture tasks table
